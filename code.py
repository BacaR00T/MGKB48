...
keyboard.keymap = [
    ...
    [
        ...
        KC.LCTRL,   KC.LGUI,    KC.LALT,    KC.TAB,     KC.BSPC,    KC.SPC,         KC.ENT,     LOWER,   RAISE,   KC.TRNS,    KC.TRNS,        KC.MINS,    
    ...
    [
        ...
        KC.TRNS,     KC.TRNS,    KC.TRNS,    KC.TRNS,   KC.TRNS,     KC.TRNS,        KC.TRNS,     KC.TRNS,    KC.TRNS,    KC.TRNS,   KC.TRNS,     KC.TRNS,
        KC.TRNS,     KC.TRNS,    KC.TRNS,    KC.MB_LMB, KC.MB_MMB,   KC.MB_RMB,      KC.TRNS,     KC.TRNS,    KC.TRNS,    KC.TRNS,   KC.TRNS,     KC.TRNS,
...
#trackball.set_red(0)
#trackball.set_green(55)
#trackball.set_blue(55)
